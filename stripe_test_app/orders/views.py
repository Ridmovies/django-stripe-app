...
def create_tax(request):
    ...
    try:
        ...
        return HttpResponse(f"Тариф налога успешно создан: {stripe_tax['id']} и сохранён в базе.", status=200)

    except Exception as e:
        return HttpResponse(f"Произошла ошибка при создании тарифа налога: {e}", status=500)